  ...
  return (
    <>
      ...
      >
        ...
        <Box mt={4} sx={{ position: "absolute", right: 0 }}>
      ...
      <Box>
        ...
        >
          ...
          {/* Description */}
          <Typography sx={{ mt: 2, fontSize: 15, color: "#fff", pl: 2, pr: 2 }}>
            Lorem ipsum dira sopspanare tad irar neledes sore: Irene Jonsson.
          </Typography>
        </Box>
      </Box>
